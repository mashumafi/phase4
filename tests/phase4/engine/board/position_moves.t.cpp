...
TEST_CASE("PositionMoves Algebraic Notation") {
	...
	// Pawn moves
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"), Move(Square::E2, Square::E4, MoveFlags::QUIET))) == "1. e4"s);

	// En passant
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbqkbnr/ppp1p1pp/8/3pPp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 3"), Move(Square::E5, Square::F6, MoveFlags::QUIET))) == "3. exf6"s);
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbqkbnr/ppp3p1/4p3/3pPpPp/8/8/PPPP1P1P/RNBQKBNR w KQkq f6 0 5"), Move(Square::G5, Square::F6, MoveFlags::QUIET))) == "5. gxf6"s);

	// Promotion
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbq3r/pppk2P1/4p3/2bpPp2/8/8/PPPP1P1P/RNB1KBNR w KQ - 1 11"), Move(Square::G7, Square::G8, MoveFlags::BISHOP_PROMOTION))) == "11. g8=♝"s);

	// Promotion + Capture
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbq3r/pppk2P1/4p3/2bpPp2/8/8/PPPP1P1P/RNB1KBNR w KQ - 1 11"), Move(Square::G7, Square::H8, MoveFlags::KNIGHT_PROMOTION_CAPTURE))) == "11. gxh8=♞"s);

	// Promotion + Check
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbqk2r/ppp3P1/4p3/2bpPp2/8/5P2/PPPP3P/RNB1KBNR w KQ - 1 12"), Move(Square::G7, Square::G8, MoveFlags::QUEEN_PROMOTION))) == "12. g8=♛+"s);
	...
	// Castling + Check
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbqk2r/ppppp2p/7b/3n4/8/5KP1/PPPPP2P/RNBQ1BNR b kq - 0 6"), Move(Square::E8, Square::G8, MoveFlags::KING_CASTLE))) == "O-O+"s);
	...
	CHECK(SV(PositionMoves::algebraicNotation(*FenToPosition::parse("K7/8/8/8/4Q2Q/8/3k4/4r2Q w - - 0 500"), Move(Square::H4, Square::E1, MoveFlags::QUIET))) == "500. ♛h4xe1#"s);
}
