...
TEST_CASE("PositionMoves Algebraic Notation") {
	...
	CHECK(PositionMoves::algebraicNotation(*FenToPosition::parse("r3k1nr/pppb4/2n1pP2/2bp1BPp/8/3P1N2/PPP2P1P/RNB2RK1 b kq - 0 11"), Move(Square::E8, Square::C8, MoveFlags::QUIET)).data() == "O-O-O"s);
	// Check
	CHECK(PositionMoves::algebraicNotation(*FenToPosition::parse("rnbqk2r/ppppp2p/7b/3n4/8/5KP1/PPPPP2P/RNBQ1BNR b kq - 0 6"), Move(Square::E8, Square::G8, MoveFlags::QUIET)).data() == "O-O+"s);
