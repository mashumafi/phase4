...
TEST_CASE("PositionMoves Algebraic Notation") {
	...
	// Castling
	CHECK(SV(PositionMoves::algebraicNotation(parseFen("rnbqk1nr/ppp5/4p3/2bpPpPp/8/5N1B/PPPP1P1P/RNB1K2R w KQkq - 2 8"), Move(Square::E1, Square::G1, MoveFlags::QUIET))) == "8. O-O"s);
