...
TEST_CASE("WallOperations slide square") {
	...
	//                                 WALLS       LANDING
	CHECK(WallOperations::SLIDE_SQUARE[Square::H1][Square::H1.north(2)] == Square::H3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G1][Square::G1.west(2)] == Square::E1);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F1][Square::F1.east(2)] == Square::H1);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E1][Square::E1.north(2)] == Square::E3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D1][Square::D1.east(2)] == Square::F1);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C1][Square::C1.west(2)] == Square::A1);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B1][Square::B1.north(2)] == Square::B3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A1][Square::A1.east(2)] == Square::C1);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H2][Square::H2.west(2)] == Square::F2);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G2][Square::G2.north(2)] == Square::G4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F2][Square::F2.west(2)] == Square::D2);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E2][Square::E2.east(2)] == Square::G2);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D2][Square::D2.north(2)] == Square::D4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C2][Square::C2.east(2)] == Square::E2);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B2][Square::B2.north(2)] == Square::B4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A2][Square::A2.north(2)] == Square::A4);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H3][Square::H3.west(2)] == Square::F3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G3][Square::G3.north(2)] == Square::G5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F3][Square::F3.north(2)] == Square::F5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E3][Square::E3.south(2)] == Square::E1);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D3][Square::D3.east(2)] == Square::F3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C3][Square::C3.west(2)] == Square::A3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B3][Square::B3.south(2)] == Square::B1);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A3][Square::A3.north(2)] == Square::A5);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H4][Square::H4.west(2)] == Square::F4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G4][Square::G4.north(2)] == Square::G6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F4][Square::F4.south(2)] == Square::F2);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E4][Square::E4.east(2)] == Square::G4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D4][Square::D4.west(2)] == Square::B4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C4][Square::C4.south(2)] == Square::C2);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B4][Square::B4.north(2)] == Square::B6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A4][Square::A4.east(2)] == Square::C4);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H5][Square::H5.west(2)] == Square::F5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G5][Square::G5.south(2)] == Square::G3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F5][Square::F5.north(2)] == Square::F7);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E5][Square::E5.west(2)] == Square::C5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D5][Square::D5.south(2)] == Square::D3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C5][Square::C5.east(2)] == Square::E5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B5][Square::B5.south(2)] == Square::B3);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A5][Square::A5.north(2)] == Square::A7);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H6][Square::H6.north(2)] == Square::H8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G6][Square::G6.west(2)] == Square::E6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F6][Square::F6.east(2)] == Square::H6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E6][Square::E6.north(2)] == Square::E8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D6][Square::D6.south(2)] == Square::D4);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C6][Square::C6.west(2)] == Square::A6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B6][Square::B6.east(2)] == Square::D6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A6][Square::A6.south(2)] == Square::A4);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H7][Square::H7.west(2)] == Square::F7);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G7][Square::G7.south(2)] == Square::G5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F7][Square::F7.east(2)] == Square::H7);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E7][Square::E7.west(2)] == Square::C7);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D7][Square::D7.south(2)] == Square::D5);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C7][Square::C7.west(2)] == Square::A7);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B7][Square::B7.east(2)] == Square::D7);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A7][Square::A7.south(2)] == Square::A5);

	CHECK(WallOperations::SLIDE_SQUARE[Square::H8][Square::H8.west(2)] == Square::F8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::G8][Square::G8.south(2)] == Square::G6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::F8][Square::F8.east(2)] == Square::H8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::E8][Square::E8.west(2)] == Square::C8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::D8][Square::D8.south(2)] == Square::D6);
	CHECK(WallOperations::SLIDE_SQUARE[Square::C8][Square::C8.west(2)] == Square::A8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::B8][Square::B8.east(2)] == Square::D8);
	CHECK(WallOperations::SLIDE_SQUARE[Square::A8][Square::A8.south(2)] == Square::A6);
}
