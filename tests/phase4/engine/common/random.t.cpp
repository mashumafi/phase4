...
TEST_CASE("Random seed next") {
	...
	CHECK(Bitset(rand.next()) == 0b1000000010110000000001010100001100100100010111011011001011001110);
	CHECK(Bitset(rand.next()) == 0b1100000110010010001100001001110101000100010010100111111111001000);
	CHECK(Bitset(rand.next()) == 0b1000111101111111001110010010100111111010011000010011000110111111);
	CHECK(Bitset(rand.next()) == 0b1011010100110100111100111100001101110001110100001001000010110101);
