...
TEST_CASE("MovesGenerator getRookMoves") {
	...
	SUBCASE("Empty occupancy") {
		//                                                         HHHHHHHH GGGGGGGG FFFFFFFF EEEEEEEE DDDDDDDD CCCCCCCC BBBBBBBB AAAAAAAA
		//                                                         87654321 87654321 87654321 87654321 87654321 87654321 87654321 87654321
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::A1) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::A2) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::B2) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::C5) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::D8) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::E1) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::F4) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::G7) == 0b0ull);
		CHECK(MovesGenerator::getRookMoves(EMPTY, Square::H2) == 0b0ull);
	}
}
...
TEST_CASE("MovesGenerator getQueenMoves") {
	...
	SUBCASE("Empty occupancy") {
		//                                                          HHHHHHHH GGGGGGGG FFFFFFFF EEEEEEEE DDDDDDDD CCCCCCCC BBBBBBBB AAAAAAAA
		//                                                          87654321 87654321 87654321 87654321 87654321 87654321 87654321 87654321
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::A1) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::A2) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::B2) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::C5) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::D8) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::E1) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::F4) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::G7) == 0b0ull);
		CHECK(MovesGenerator::getQueenMoves(EMPTY, Square::H2) == 0b0ull);
	}
}
...
TEST_CASE("MovesGenerator getKingMoves") {
	...
	//                                                  HHHHHHHH GGGGGGGG FFFFFFFF EEEEEEEE DDDDDDDD CCCCCCCC BBBBBBBB AAAAAAAA
	//                                                  87654321 87654321 87654321 87654321 87654321 87654321 87654321 87654321
	CHECK(MovesGenerator::getKingMoves(Square::A1) == 0b00000000'00000000'00000000'00000000'00000000'00000000'00000011'00000010ull);
	CHECK(MovesGenerator::getKingMoves(Square::A2) == 0b00000000'00000000'00000000'00000000'00000000'00000000'00000111'00000101ull);
	CHECK(MovesGenerator::getKingMoves(Square::B2) == 0b00000000'00000000'00000000'00000000'00000000'00000111'00000101'00000111ull);
	CHECK(MovesGenerator::getKingMoves(Square::C5) == 0b00000000'00000000'00000000'00000000'00111000'00101000'00111000'00000000ull);
	CHECK(MovesGenerator::getKingMoves(Square::D8) == 0b00000000'00000000'00000000'11000000'01000000'11000000'00000000'00000000ull);
	CHECK(MovesGenerator::getKingMoves(Square::E1) == 0b00000000'00000000'00000011'00000010'00000011'00000000'00000000'00000000ull);
	CHECK(MovesGenerator::getKingMoves(Square::F4) == 0b00000000'00011100'00010100'00011100'00000000'00000000'00000000'00000000ull);
	CHECK(MovesGenerator::getKingMoves(Square::G7) == 0b11100000'10100000'11100000'00000000'00000000'00000000'00000000'00000000ull);
	CHECK(MovesGenerator::getKingMoves(Square::H2) == 0b00000101'00000111'00000000'00000000'00000000'00000000'00000000'00000000ull);
}
