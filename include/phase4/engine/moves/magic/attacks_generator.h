...
public:
	static inline constexpr common::Bitboard getFileRankAttacks(common::Bitboard board, common::Square square) noexcept {
	...
	static inline constexpr common::Bitboard getDiagonalAttacks(common::Bitboard board, common::Square square) noexcept {
...
private:
	static inline constexpr common::Bitboard getAttacksForDirection(common::Bitboard board, common::Square square, common::FieldIndex shift) noexcept {
